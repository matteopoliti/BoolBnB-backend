        ...
        <div class="container">
            ...
            <form action="{{ route('dashboard.apartments.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row my-3">
                    ...
                    <div class=" col-3 ">
                        <label for="price" class="form-label">Insert the price/night</label>
                    ...
                    <div class="col-3 ">
                        <label for="num_rooms" class="form-label">Insert the number of rooms</label>
                        <input type="number" class="form-control @error('num_rooms') is-invalid @enderror" id="num_rooms"
                            aria-describedby="num_rooms" name="num_rooms" value='{{ old('num_rooms') }}' required>
                        @error('num_rooms')
                            <div class="alert alert-danger mt-1">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-3 ">
                        <label for="num_beds" class="form-label">Insert the number of beds</label>
                        <input type="number" class="form-control @error('num_beds') is-invalid @enderror" id="num_beds"
                            aria-describedby="num_beds" name="num_beds" value='{{ old('num_beds') }}' required>
                        @error('num_beds')
                            <div class="alert alert-danger mt-1">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-3 ">
                        <label for="num_bathrooms" class="form-label">Insert the number of bathrooms</label>
                ...
                <div class="row my-3">
                    ...
                    <div class="col-6">
                        <label for="square_meters" class="form-label">Insert the number of square meters</label>
