...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card">
                <img src="{{ $apartment->cover_image }}" class="card-img-top" alt="Immagine dell'appartamento">
                <div class="card-body">
        ...
        <div class="col-lg-4 d-flex flex-column justify-content-around">
            ...
            <div>
                ...
                @endforeach
                <form action="{{ route('sponsorships.store', $apartment->id) }}" method="POST" id="sponsorship-form" class="text-center">
                    @csrf
